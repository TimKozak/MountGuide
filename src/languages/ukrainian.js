const UKRAINIAN = {
  ...
  form: {
    ...
    tourists: {
      ...
      question2: {
        ...
        text: "Ви є...",
        options: ["турист-аматор", "професіонал"],
      },
      question3: {
        googlesheet: "preference",
        text: "Ходити в гори...",
        options: ["самостійно", "з друзями", "з гідом"],
      },
      question4: {
        googlesheet: "age_city",
        text: "Ваш вік, місто проживання",
  ...
  partners: {
    ...
    partner1: {
      name: "Команда GRA",
      text: "– твій гірський провідник",
      link: "https://gra.travel/",
    },
    partner2: {
      name: "Компанія мандрівників Fun Karpaty",
      text: "– це об'єднання гідів, альпіністів, рятувальників та просто любителів активного відпочинку",
